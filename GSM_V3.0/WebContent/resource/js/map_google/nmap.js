...
OpenLayers.Control.NLibNavigation = OpenLayers.Class(OpenLayers.Control, {
    slideFactor: 50, inited: false, slideRatio: null, initialize: function (options) { this.position = new OpenLayers.Pixel(5, 10); OpenLayers.Control.prototype.initialize.apply(this, arguments); }, destroy: function () { if (this.map) { this.map.events.unregister("zoomend", this, this.zoomend); } OpenLayers.Control.prototype.destroy.apply(this, arguments); }, setMap: function (map) { OpenLayers.Control.prototype.setMap.apply(this, arguments); this.map.events.register("zoomend", this, this.zoomend); }, draw: function (px) {
        var img = "url(" + OpenLayers.Util.getImageLocation("mapcontrols3.png") + ")"; var bimg = "url(" + OpenLayers.Util.getImageLocation("blank.gif") + ")"; OpenLayers.Control.prototype.draw.apply(this, arguments); px = this.position || px; setPos(this.div, px.x, px.y, 64.5, 190, 1100, this); var self = this; var zoomin = document.createElement("div"); zoomin.id = "zoomin"; zoomin.title = "放大"; setPos(zoomin, 14, 46, 20, 18, 10, this); setBG(zoomin, img, "0px -221px", "initial initial", null, null, null, null, null); this.div.appendChild(zoomin); zoomin.onclick = function (e) { return self.onclick(e); }; zoomin.ondblclick = function (e) { stopEvent(e); return true; }; zoomin.onmouseover = function (e) { zoomin.style.backgroundPosition = "0px -243px"; }; zoomin.onmouseout = function (e) { zoomin.style.backgroundPosition = "0px -221px"; }; var zoomout = document.createElement("div"); zoomout.id = "zoomout"; zoomout.title = "缩小"; setPos(zoomout, 14, 176, 20, 18, 10, this); setBG(zoomout, img, "0px -265px", "initial initial", null, null, null, null, null); this.div.appendChild(zoomout); zoomout.onclick = function (e) { return self.onclick(e); }; zoomout.ondblclick = function (e) { stopEvent(e); return true; }; zoomout.onmouseover = function (e) { zoomout.style.backgroundPosition = "0px -287px"; }; zoomout.onmouseout = function (e) { zoomout.style.backgroundPosition = "0px -265px"; }; var pan = document.createElement("div"); pan.title = ""; setPos(pan, 2, 0, 42, 43, 10, this); setBG(pan, img, "0px 0px", "initial initial", null, null, null, null, null); this.div.appendChild(pan); pan.onmouseout = function (e) { pan.style.backgroundPosition = "0px 0px"; }; var panleft = document.createElement("div"); panleft.id = "panleft"; panleft.title = "左移"; setPos(panleft, 0, 12, 12, 12, 10, this); pan.appendChild(panleft); panleft.onclick = function (e) { return self.onclick(e); }; panleft.ondblclick = function (e) { stopEvent(e); return true; }; panleft.onmouseover = function (e) { pan.style.backgroundPosition = "0px -176px"; }; var panright = document.createElement("div"); panright.id = "panright"; panright.title = "右移"; setPos(panright, 27, 11, 12, 12, 10, this); pan.appendChild(panright); panright.onclick = function (e) { return self.onclick(e); }; panright.ondblclick = function (e) { stopEvent(e); return true; }; panright.onmouseover = function (e) { pan.style.backgroundPosition = "0px -88px"; }; var panup = document.createElement("div"); panup.id = "panup"; panup.title = "上移"; setPos(panup, 13, 0, 12, 12, 10, this); pan.appendChild(panup); panup.onclick = function (e) { return self.onclick(e); }; panup.ondblclick = function (e) { stopEvent(e); return true; }; panup.onmouseover = function (e) { pan.style.backgroundPosition = "0px -44px"; }; var pandown = document.createElement("div"); pandown.id = "pandown"; pandown.title = "下移"; setPos(pandown, 13, 25, 12, 12, 10, this); pan.appendChild(pandown); pandown.onclick = function (e) { return self.onclick(e); }; pandown.ondblclick = function (e) { stopEvent(e); return true; }; pandown.onmouseover = function (e) { pan.style.backgroundPosition = "0px -132px"; }; var bar = document.createElement("div"); setPos(bar, 21, 64, 6, 111, 3, this); setBG(bar, img, "-24px -225px", "no-repeat no-repeat", null, null, null, null, null); this.div.appendChild(bar); var bar2 = document.createElement("div"); setPos(bar2, -6, 37, 18, 10, 5, this); setBG(bar2, img, "0px -309px", "initial initial", null, null, null, null, null); bar2.style.cursor = "pointer"; bar.appendChild(bar2); var bar2down = false; var mouseY = 0; bar2.onmousedown = function (e) {
            e = e || window.event; stopEvent(e); bar2down = true;
            mouseY = e.screenY;
        }; bar2.onmouseup = function (e) { stopEvent(e); bar2down = false; }; bar2.onmouseover = function (e) { bar2.style.backgroundPosition = "0px -320px"; }; bar.onmouseout = function (e) { bar2down = false; bar2.style.backgroundPosition = "0px -309px"; }; var bar3 = document.createElement("div"); bar.onmousemove = function (e) { e = e || window.event; stopEvent(e); var o = e.screenY - mouseY; if (bar2down) { var len = toint(bar.style.height); var newpos = toint(bar2.style.top) + o; var d = len - newpos; var level = Math.round(d * 18 / len); bar2.style.top = newpos + "px"; bar3.style.top = newpos + "px"; bar3.style.height = (toint(bar.style.height) - newpos + toint(bar2.style.height)) + "px"; self.nozoomed = true; self.map.setZoom(level); self.nozoomed = false; } mouseY = e.screenY; }; setPos(bar3, 0, 37, 6, 111 - 37, 4, this); setBG(bar3, img, "-33px 100%", "no-repeat no-repeat", "auto", "padding-box", "border-box", "transparent", "scroll"); bar.appendChild(bar3); this.bar = bar; this.bar2 = bar2; this.bar3 = bar3; this.zoomin = zoomin; this.zoomout = zoomout; var btns = document.createElement("div"); setPos(btns, 18, 50, 45, 152, 2, this); setBG(btns, bimg, "0px -400px", "no-repeat no-repeat", "auto", "padding-box", "border-box", "transparent", "scroll"); this.div.appendChild(btns); var b1 = document.createElement("div"); b1.id = "zoomjie"; b1.title = "街"; setPos(b1, 16, 28, 27, 18, 5, this); setBG(b1, img, "0px -380px", "no-repeat no-repeat", "auto", "padding-box", "border-box", "transparent", "scroll"); b1.style.display = "none"; btns.appendChild(b1); b1.onclick = function (e) { return self.onclick(e); }; var b2 = document.createElement("div"); b2.id = "zoomshi"; b2.title = "市"; setPos(b2, 16, 52, 27, 18, 5, this); setBG(b2, img, "0px -400px", "no-repeat no-repeat", "auto", "padding-box", "border-box", "transparent", "scroll"); b2.style.display = "none"; btns.appendChild(b2); b2.onclick = function (e) { return self.onclick(e); }; var b3 = document.createElement("div"); b3.id = "zoomsheng"; b3.title = "省"; setPos(b3, 16, 82, 27, 18, 5, this); setBG(b3, img, "0px -421px", "no-repeat no-repeat", "auto", "padding-box", "border-box", "transparent", "scroll"); b3.style.display = "none"; btns.appendChild(b3); b3.onclick = function (e) { return self.onclick(e); }; var b4 = document.createElement("div"); b2.id = "zoomguo"; b4.title = "国"; setPos(b4, 16, 106, 27, 18, 5, this); setBG(b4, img, "0px -442px", "no-repeat no-repeat", "auto", "padding-box", "border-box", "transparent", "scroll"); b4.style.display = "none"; btns.appendChild(b4); b4.onclick = function (e) { return self.onclick(e); }; btns.onmouseout = function () { b1.style.display = "none"; b2.style.display = "none"; b3.style.display = "none"; b4.style.display = "none"; }; btns.onmouseover = function () { b1.style.display = ""; b2.style.display = ""; b3.style.display = ""; b4.style.display = ""; }; if (!this.inited) { this.zoomend(); this.inited = true; } return this.div;
    }, zoomend: function () { if (this.nozoomed) { return; } var bar = this.bar; var bar2 = this.bar2; var bar3 = this.bar3; var zoomin = this.zoomin; var zoomout = this.zoomout; var level = this.map.getZoom(); var len = toint(bar.style.height); var pos = len - len * level / 18; bar2.style.top = (pos) + "px"; pos += toint(bar2.style.height); bar3.style.top = (pos) + "px"; bar3.style.height = (toint(bar.style.height) - pos + toint(bar2.style.height)) + "px"; }, onclick: function (e) { e = e || window.event; stopEvent(e); var obj = e.srcElement ? e.srcElement : e.target; switch (obj.id) { case "panup": this.map.pan(0, -this.getSlideFactor("h")); break; case "pandown": this.map.pan(0, this.getSlideFactor("h")); break; case "panleft": this.map.pan(-this.getSlideFactor("w"), 0); break; case "panright": this.map.pan(this.getSlideFactor("w"), 0); break; case "zoomin": this.map.zoomIn(); break; case "zoomout": this.map.zoomOut(); break; case "zoomguo": this.map.zoomTo(2); break; case "zoomsheng": this.map.zoomTo(6); break; case "zoomshi": this.map.zoomTo(11); break; case "zoomjie": this.map.zoomTo(15); break; } return true; }, getSlideFactor: function (dim) { return this.slideRatio ? this.map.getSize()[dim] * this.slideRatio : this.slideFactor; }, CLASS_NAME: "OpenLayers.Control.NLibNavigation"
});
OpenLayers.Control.NLibLayerSwitch = OpenLayers.Class(OpenLayers.Control, {
    baseLayers: "", initialize: function (options) { OpenLayers.Control.prototype.initialize.apply(this, arguments); this.baseLayers = ""; }, draw: function () { if (this.div == null) { this.div = OpenLayers.Util.createDiv(this.id); this.div.className = "map_maptype"; var ul = document.createElement("ul"); this.div.appendChild(ul); var li0 = document.createElement("li"); li0.className = "t_sep"; ul.appendChild(li0); var li1 = document.createElement("li"); li1.className = ""; li1.innerHTML = "<p>地图</p>"; ul.appendChild(li1); var li2 = document.createElement("li"); li2.className = "t_sep"; ul.appendChild(li2); var li3 = document.createElement("li"); li3.className = ""; li3.innerHTML = "<p>卫星</p>"; ul.appendChild(li3); var li4 = document.createElement("li"); li4.className = "t_sep"; ul.appendChild(li4); var self = this; li1.onmousedown = function () { self.setCurrent(0); }; li3.onmousedown = function () { li2.className = "t_sep t_sep_c"; li3.className = "now_li"; li4.className = "t_sep t_sep_c"; self.setCurrent(1); }; this.li0 = li0; this.li1 = li1; this.li2 = li2; this.li3 = li3; this.li4 = li4; this.setCurrent(0); } return this.div; }, setCurrent: function (t) {
        this.li0.className = (t == 0) ? "t_sep t_sep_c" : "t_sep"; this.li1.className = (t == 0) ? "now_li" : ""; this.li2.className = (t == 0 || t == 1) ? "t_sep t_sep_c" : "t_sep";
        this.li3.className = (t == 1) ? "now_li" : ""; this.li4.className = (t == 2 || t == 1) ? "t_sep t_sep_c" : "t_sep"; if (this.map) { if (t == 0) { this.map.setBaseLayer(this.map.getLayer("OpenLayers_Layer_TMS_15")); } else { if (t == 1) { this.map.setBaseLayer(this.map.getLayer("OpenLayers_Layer_TMS_17")); } } }
...
//地图瓦片方法
function get_google_url(bounds) {
...
function drawmap(points, destroylayer) {
    ...
    for (var i = 0; i < zu.length; i++) {
        ...
        if (dian.length == 1) {
            ...
            var ft = new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point(mercator.x, mercator.y), { type: 5 });
            ...
            for (var j = 0; j < dian.length; j++) {
                ...
                var lonlat = { x: x, y: y };
                var mercator = lonLatToMercator(lonlat);
                var newPoint = new OpenLayers.Geometry.Point(mercator.x + Math.random(1), mercator.y + Math.random(1));
        ...
        for (var i = 0; i < zu.length; i++) {
            ...
            if (dian.length == 1) {
                ...
                for (var j = 0; j < dian.length; j++) {
                    ...
                    var lonlat1 = { x: x1, y: y1 };
                    var mercator = lonLatToMercator(lonlat1);
                    var newPoint = new OpenLayers.Geometry.Point(mercator.x + Math.random(1), mercator.y + Math.random(1));
                    pointList.push(newPoint);
                }
                var linearRing = new OpenLayers.Geometry.LinearRing(pointList);
...
function getboud(x, y) {
    ...
    var mercatormin = lonLatToMercator(lonlatmin);
    var mercatormax = lonLatToMercator(lonlatmax);
    var b = { minx: 0, miny: 0, maxx: 0, maxy: 0 };
    b.minx = mercatormin.x;
    b.miny = mercatormin.y;
    b.maxx = mercatormax.x;
    b.maxy = mercatormax.y;
    return b;
}
//颜色随机数
function getclnum() {
...
function initialGMaps(para) {
    ...
    var google_m = new OpenLayers.Layer.TMS("google地图",
        [
            "http://mt0.google.cn/vt/lyrs=m@267000000&hl=zh-CN&gl=cn&src=app&",
					"http://mt1.google.cn/vt/lyrs=m@267000000&hl=zh-CN&gl=cn&src=app&",
					"http://mt2.google.cn/vt/lyrs=m@267000000&hl=zh-CN&gl=cn&src=app&",
					"http://mt3.google.cn/vt/lyrs=m@267000000&hl=zh-CN&gl=cn&src=app&"
        ], {
            'type': 'png',
            'isBaseLayer': true,
            'getURL': get_google_url
        });
    var google_i = new OpenLayers.Layer.TMS("google卫星",
        [
            "http://mt0.google.cn/vt/lyrs=s,r&hl=zh-CN&gl=cn&",
					"http://mt1.google.cn/vt/lyrs=s,r&hl=zh-CN&gl=cn&",
					"http://mt2.google.cn/vt/lyrs=s,r&hl=zh-CN&gl=cn&",
					"http://mt3.google.cn/vt/lyrs=s,r&hl=zh-CN&gl=cn&"
        ], {
            'layername': "googleimage",
            'type': 'png',
            'isBaseLayer': true,
            'getURL': get_google_url
        });

    map.addLayer(google_m);
    map.addLayer(google_i);
            ...
            trigger: function () {
                ...
                for (var i = 0 ; i < features.length; i++) {
                    ...
                    for (var j = 0; j < lonlats.length; j++) {
                        ...
                        pointsstring += lonlat.x + "," + lonlat.y + ";";
                    }
    ...
    if (para.points.length > 0) {
        ...
        //中心点
        var centerpoint = new NMap.LonLat(119.487853, 39.832690);
        map.setCenter(centerpoint.transform(proj4326, map.getProjectionObject()), 11);
    }
}
