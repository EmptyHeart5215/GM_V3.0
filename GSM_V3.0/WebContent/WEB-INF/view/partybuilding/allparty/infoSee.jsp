...
<script type="text/javascript">
  $(function(){
	  var partyType = '${vdata.allparty.codePartyType }'
            ...
            <div id="detailDiv" class="tab-pane in active">
               <div class="col-xs-12" style='text-align:right;'>
	            ...
	            <div id="print">
					...
					<table id="tbcontent" align="right" width="100%" border="1" >
					   <tr height="28px;">
					     <td width="15%" align="right"><b>所属辖区</b></td>
					     <td width="75%" colspan="3">${vdata.allparty.seatGrid.gridTotalName }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>姓名</b></td>
					     <td width="30%">${vdata.allparty.name }</td>
					     <td width="15%" align="right"><b>身份证</b></td>
					     <td width="30%">${vdata.allparty.cid }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>性别</b></td>
					     <td width="30%">${vdata.allparty.sex }</td>
					     <td width="15%" align="right"><b>民族</b></td>
					     <td width="30%">${vdata.allparty.dicValueMap.codeNation}</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>文化程度</b></td>
					     <td width="30%">${vdata.allparty.dicValueMap.codeEducation }</td>
					     <td width="15%" align="right"><b>政治面貌</b></td>
					     <td width="30%">${vdata.allparty.dicValueMap.codePolitical }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>党员类型</b></td>
					     <td width="30%" id="partytype"></td>
					     <td width="15%" align="right"><b>入党时间</b></td>
					     <td width="30%">${vdata.allparty.inPartyDate }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" rowspan="2" align="right"><b>备注</b></td>
					     <td width="75%" colspan="3" rowspan="2" style="word-break:break-all; word-wrap:break-word;" >${vdata.allparty.remark }</td>
					   </tr>
					   <tr height="28px;">
					   </tr>
					</table>
