	...
	$("#mapSearchSearch").click(function(){
		...
		$("#grid-table").jqGrid({
			...
			defaultCaozuo:false,
		 	ondblClickRow:function(rowid,iRow,iCol,e){
		 		 ...
		 		 var code = rowData.code;
		 		  var show = "[";
		 		  show += "{\"NAME\":\""+Name+"\",\"POSITION\":\""+position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:400px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='yes' frameborder='0' src='${base}/base/bjigou/infoSee?code="+code+"'></iframe></div>\"},";
	        ...
	        colModel:[
	            ...
	            {name:'managerPhone',index:'managerPhone',sortable:true, width:'15%',align:'left'},
	            {name:'beginTime',index:'beginTime',sortable:true, width:'20%', align:"left"},
	            {name:'dicValueMap.codeJigouState',index:'codeJigouState',sortable:true, width:'20%', align:"left"},
...
var mapSearchLoad = function (data){
	...
	for(var i  = 0;i<rows.length;i++){
		var row = rows[i];
		show += "{\"NAME\":\""+row.Name+"\",\"POSITION\":\""+row.position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:400px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='no' frameborder='0' src='${base}/base/bjigou/infoSee?code="+row.code+"'></iframe></div>\"},";
	}
	show = show.substring(0,show.length-1)+"]";
...
<div style="width: 100%;height: 780px;">
		<div style="width: 100%; height: 30px;z-index: 10; position: absolute;text-align:center;">
			<button style="margin-top:-3px;"class="btn btn-minier btn-yellow" onclick="showmapSearch();">机构队伍查询
		...
		<div id="mapSearchDiv" hidden="hidden">
		  <div style="width: 100%; height: 30px;background-color: #F8F8F8">
		    <div style="margin-top: 5px;margin-left: 10px;"><b>机构队伍查询条件</b></div>
		  ...
		  <form id="search_form"style="padding-top: 20px;">
		   <table style="width: 100%;text-align: center;">
		      <tr height="28px;">
		        ...
		        <td width="25%">
		           <div class="col-xs-12">
					  <input type="text"  name="jigouManager" class="col-xs-12 col-sm-12" />
					</div>
		        </td>
		      </tr>
		       <tr height="28px;">
		        ...
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="managerPhone" type="text" class="text col-xs-12" >
				  </div>
		        </td>											
		        <td width="10%">所属网格员电话</td>
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="gridContactsPhone" type="text" class="text col-xs-12" >
				  </div>
		        </td>
		        <td width="10%">机构地址</td>
		        <td width="25%">
		           <div class="col-xs-12">
					  <input type="text"  name="address" class="col-xs-12 col-sm-12" />
					</div>
		        </td>
		      </tr>
		       <tr height="5px;">
