		...
		$("#grid-table").jqGrid({
		 	...
		 	ondblClickRow:function(rowid,iRow,iCol,e){
		 		 ...
		 		 var code = rowData.code;
		 		  var show = "[";
		 		  show += "{\"NAME\":\""+Name+"\",\"POSITION\":\""+position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:525px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='yes' frameborder='0' src='${base}/eventfile/efcontradict/detailLoad?eventCode="+code+"'></iframe></div>\"},";
	        ...
	        colModel:[
			            ...
			            {name:'codeEventType',index:'codeEventType',sortable:false, width:'5%', align:"center"},
			            {name:'contradictionsDate',index:'contradictionsDate',sortable:false, width:'5%', align:"center"},
			            {name:'supervisionDuty',index:'supervisionDuty',sortable:false, width:'10%', align:"center"},
			            {name:'supervisionPerson',index:'supervisionPerson',sortable:false, width:'10%', align:"center"},
			            {name:'takeName',index:'takeName',sortable:false, width:'10%', align:"center"},
			            {name:'problemName',index:'problemName',sortable:false, width:'10%', align:"center"},
			            {name:'problemResolution',index:'problemResolution',sortable:false, width:'10%', align:"center"},
			            {name:'position',index:'position',sortable:false, width:'10%', align:"center",hidden:true},
			           ],
	        sortable:false,
...
var mapSearchLoad = function (data){
	...
	for(var i  = 0;i<rows.length;i++){
		var row = rows[i];
		show += "{\"NAME\":\""+row.Name+"\",\"POSITION\":\""+row.position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:525px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='yes' frameborder='0' src='${base}/eventfile/efcontradict/detailLoad?eventCode="+row.code+"'></iframe></div>\"},";
	}
	show = show.substring(0,show.length-1)+"]";
...
<div style="width: 100%;height: 780px;">
		...
		<div id="mapSearchDiv" class=""  hidden="hidden">
		  <div style="width:100%; height: 30px;background-color: #F8F8F8">
		    <div style="margin-top: 5px;margin-left: 10px;"><b>矛盾纠纷查询条件</b></div>
		  ...
		  <form id="search_form" style="padding-top:20px">
		   <table style="width: 100%;text-align: center;">
		      <tr height="28px;">
		        ...
		        <td width="10%">矛盾纠纷级别 </td>
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="codeEventType" type="text" class="text col-xs-12" >
				  </div>
		        </td>
		        <td width="10%">矛盾排查时间</td>
		        <td width="25%">
		           <div class="col-xs-12">
					  <input type="text"  name="contradictionsDate" class="col-xs-12 col-sm-12 date-picker" />
					</div>
		        </td>
		      </tr>
		       <tr height="28px;">
		        ...
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="supervisionDuty" type="text" class="text col-xs-12" >
				  </div>
		        </td>											
		        <td width="10%">督办人 </td>
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="supervisionPerson" type="text" class="text col-xs-12" >
				  </div>
		        </td>
		        <td width="10%">责任人</td>
		        <td width="25%">
		           <div class="col-xs-12">
					  <input type="text"  name="problemName" class="col-xs-12 col-sm-12" />
					</div>
		        </td>
		      </tr>
		       <tr height="28px;">
				<td width="10%">问题化解情况</td>
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="problemResolution" type="text" class="text col-xs-12" >
				  </div>
		        </td>											
