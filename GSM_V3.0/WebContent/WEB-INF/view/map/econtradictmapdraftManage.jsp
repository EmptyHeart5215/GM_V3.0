			...
			defaultCaozuo:false,
		 	...
		 	ondblClickRow:function(rowid,iRow,iCol,e){
		 		 ...
		 		 var entryId = rowData['step.entryId'];
		 		  var show = "[";
		 		  show += "{\"NAME\":\""+Name+"\",\"POSITION\":\""+position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:525px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='no' frameborder='0' src='${base}/event/econtradict/detailLoad?eventCode="+code+"&stepId="+stepId+"&entryId="+entryId+"'></iframe></div>\"},";
		 		 show = show.substring(0,show.length-1)+"]";
