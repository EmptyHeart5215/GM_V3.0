...
<html lang="en">
	...
	$(function(){
		...
		minViewMode:'years'
		 ...
		 $("#grid-table").jqGrid({
		        defaultCaozuo:false,
		        colNames:[ '字典主键', '考核对象','巡查走访','民情日志','矛盾排查化解','事件得分','总分'],
		        colModel:[
					{name:'code',index:'code',sortable:false, hidden:true},
		            {name:'gridTotalName',index:'gridTotalName', width:'25%'},
		            {name:'xunChaScore', width:'10%'},
		            {name:'logScore', width:'10%'},
		 ...
		 $("#search").click(function(){
			 ...
			 $('#grid-table').jqGrid('setGridParam', {url:"${base}/eva/statisticsgrid/queryStatisticsGrid",mtype:"POST",
			postData:data 
			 }).trigger('reloadGrid');
			});
	 });
