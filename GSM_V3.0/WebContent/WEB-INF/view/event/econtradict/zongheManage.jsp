...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/event/econtradict/zongheManage",
		      defaultCaozuo:false,
		      multiselect:false,
		      ondblClickRow:function(rowid,iRow,iCol,e){
		    	  var code=$('#grid-table').jqGrid('getGridParam', "selrow");
		    	  bootbox.dialog({
						 url:"${base}/event/econtradict/detailLoad?eventCode="+code+"&stepId=1&entryId=1",
						  title: "事件处理表",
						  iframeStyle:'height:1500px;',
						  style:'width:1000px;height:600px;'
						});
		      },
		        colNames:['序号', '受理编号', '事件预警','事件状态','所属辖区','当事人','矛盾类型','矛盾主题','办理部门','受理时间','办理时限'],
		        colModel:[
