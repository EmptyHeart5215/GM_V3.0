...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/event/econtradict/beizhuxiaoManage",
		      defaultCaozuo:false,
		      multiselect:false,
		      ondblClickRow:function(rowid,iRow,iCol,e){
		        ...
		        colNames:['序号','','', '受理编号','所属辖区','矛盾主题','当事人','登记人','登记时间','注销时间','矛盾详情'],
		        colModel:[
		            ...
		            {name:'createName',index:'createName',sortable:true, width:'10%'},
		            {name:'createDate',index:'createDateStr',sortable:true, width:'10%'},
		            {name:'banLiDate',index:'cancelDateStr',sortable:true, width:'10%'},
