...
$(function() {
 ...
 $("[name='gridCode']").ztreeGrid({
	...
	$("#mapSearchSearch").click(function(){
		...
		$("#grid-table").jqGrid({
			url : "${base }/eventfile/efkeyplace/queryManage",
			defaultCaozuo:false,
		 	ondblClickRow:function(rowid,iRow,iCol,e){
		 		 ...
		 		 var code = rowData.code;
		 		  var show = "[";
		 		  show += "{\"NAME\":\""+Name+"\",\"POSITION\":\""+position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:525px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='yes' frameborder='0' src='${base}/eventfile/efkeyplace/detailLoad?eventCode="+code+"'></iframe></div>\"},";
		 	...
		 	postData:postData,
		 	mtype:"POST",//提交方式
		 	colNames:['序号', '所属辖区', '治安重点地区名称','主管或所属单位','单位负责人','管理负责人','diutu'],
	        colModel:[
				{name:'code',index:'code',sortable:false, hidden:true},
				{name:'seatGrid.gridTotalName',sortable:true, width:'15%'},
	            {name:'troubleName',index:'troubleName',sortable:true, width:'5%', align:"center"},
	            {name:'belongUnit',index:'belongUnit',sortable:true, width:'5%', align:"center"},
	            {name:'unitName',index:'unitName',sortable:true, width:'10%', align:"center"},
	            {name:'adminName',index:'adminName',sortable:true, width:'10%', align:"center"},
...
var mapSearchLoad = function (data){
	...
	for(var i  = 0;i<rows.length;i++){
		var row = rows[i];
		show += "{\"NAME\":\""+row.Name+"\",\"POSITION\":\""+row.position+"\",\"IMG\":\"${base}/resource/js/map/img/2015062904.png\",\"HTML\":\"<div style='height:525px;width:800px;'><iframe width='100%' height='100%' marginheight='0' marginwidth='0' scrolling='no' frameborder='0' src='${base}/eventfile/efkeyplace/detailLoad?eventCode="+row.code+"'></iframe></div>\"},";
	}
	show = show.substring(0,show.length-1)+"]";
...
<div style="width: 100%;height: 580px;">
		<div style="width: 100%; height: 30px;text-align:center;z-index: 10; position: absolute;">
								<button style="margin-top:-3px;" class="btn btn-minier btn-yellow" onclick="showmapSearch();">治安重点地区查询
		...
		<div id="mapSearchDiv"  hidden="hidden">
		  <div style="width:100%; height: 30px;background-color: #F8F8F8">
		    <div style="margin-top: 5px;margin-left: 10px;"><b>治安重点地区查询条件</b></div>
		  ...
		  <form id="search_form" style="padding-top:20px">
		   <table style="width: 100%;text-align: center;">
		     <tr height="28px;">
		        ...
		        <td width="10%">治安重点地区名称 </td>
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="troubleName" type="text" class="text col-xs-12" >
				  </div>
		        </td>
		        <td width="10%">主管或所属单位</td>
		        <td width="25%">
		           <div class="col-xs-12">
					  <input type="text"  name="belongUnit" class="col-xs-12 col-sm-12" />
					</div>
		        </td>
		      </tr>
		      <tr height="28px;">
		        ...
		        <td width="10%">管理责任人</td>
		        <td width="25%">
		          <div class="col-xs-12">
					 <input name="adminName" type="text" class="text col-xs-12" >
				  </div>
		        </td>
		        <td width="10%">存在的治安问题</td>
		        <td width="25%">
		           <div class="col-xs-12">
					  <input type="text"  name="securityPro" class="col-xs-12 col-sm-12" />
					</div>
		        </td>
		      </tr>
		        <tr height="30px;">
