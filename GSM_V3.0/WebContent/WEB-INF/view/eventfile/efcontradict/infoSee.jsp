			...
			<!-- 基本信息 --> 
				...
				<div class='ui-pg-div ui-inline-edit'title='打印' style='cursor:pointer;' onclick="print('print')">
					...
					<table width="60%" align="center">
					  <tr>
					     <td width="18%">网格编码：</td>
					     <td width="35%">${vdata.efcontradict.gridCode }</td>
					      <td width="18%">创建日期：</td>
					     <td width="35%">${vdata.efcontradict.createDate }</td>
					  </tr>
					</table>
						<table class="print-table" >
							<tr><td class="col-xs-2">所属辖区</td><td colspan="3" class="print-normal col-xs-4">${vdata.efcontradict.seatGrid.gridTotalName }</td></tr>
