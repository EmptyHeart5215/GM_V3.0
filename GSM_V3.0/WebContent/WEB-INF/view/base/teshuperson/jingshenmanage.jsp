...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/base/pertsjingshen/queryManage",
		        defaultCaozuo:false,
		        ...
		        colNames:[ '', '','所属辖区','楼栋','单元','房屋','身份证号','姓名','性别','诊断类型','危险性评估等级','治疗情况'],
		        colModel:[
					...
					{name:'dicValueMap.codeZhenDuanType',sortable:false, width:'15%'},
		            {name:'dicValueMap.codeWeiXianClasses',sortable:false, width:'15%'},
		            {name:'dicValueMap.codeZhiLiaoSituation',sortable:false, width:'15%'}
		        ],
								...
								<form id="search_form">
									<table style="width:100%;">
										...
										<tr>
											<td >
												<div class="search-group">
													<label class="col-xs-2 col-myxs-15 control-label text-right" >诊断类型</label>
													<input name="codeZhenDuanType" type="text" class="text col-xs-2" >
													<label class="col-xs-2 col-myxs-15 control-label text-right">危险性评估等级</label>
													<input name="codeWeiXianClasses" type="text" class="text col-xs-2"  >
													<label class="col-xs-2 col-myxs-15 control-label text-right">治疗情况</label>
													<input name="codeZhiLiaoSituation" type="text" class="text col-xs-2"  >
													</div>
											</td>
										</tr>
									</table>
