...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/base/perliushou/queryManage",
		        defaultCaozuo:false,
		        ondblClickRow:function(rowid,iRow,iCol,e){
			    	  var code=$('#grid-table').jqGrid('getGridParam', "selrow");
			    	  var rowData = $('#grid-table').jqGrid("getRowData",code);
			    	  bootbox.dialog({
							 url:"${base}/base/person/infoSee?personCode="+rowData.personCode+"&personType=liushou",
							  title: "人口信息采集表",
							  style:'width:1000px;height:600px;',
							  showFunctionBtn:false, 
							});
			      },
		        colNames:[ '','', '所属辖区','楼栋','单元','房屋','身份证号','姓名','性别','人户一致标识','留守类型'],
		        colModel:[
		            ...
		            {name:'dicValueMap.codeLiuShouType',sortable:false, width:'15%'}
										...
										<tr>
											<td >
												<div class="search-group form-group">
													...
													<label class="col-xs-2 col-myxs-15 control-label text-right" >留守类型</label>
													<input type="text"  name="codeLiuShouType" class="col-xs-2 " />
												</div>
											</td>
										</tr>
									</table>
