...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/sys/sysgpsdevice/queryManage",
		        ...
		        autowidth:true,//自动宽
		        defaultCaozuo:false,
		        colNames:[ '字典主键', '设备名称','设备IMEI','设备电话','绑定用户','真实姓名','状态','操作'],
		        colModel:[
					{name:'code',index:'code',sortable:false, hidden:true},
		            {name:'gpsName',index:'gpsName',sortable:true, width:'15%',align:'left'},
		            {name:'gpsImei',index:'gpsImei',sortable:true, width:'20%', align:"left"},
		            {name:'gpsSimno',index:'gpsSimno',sortable:true, width:'20%', align:"left"},
		            {name:'gpsUsercode',index:'gpsUsercode', width:'35%', align:"left", sortable:false},
		            {name:'gpsPosition_msg',index:'gpsPosition_msg',sortable:true, width:'20%', align:"left"},
		            {name:'gpsSimno',index:'gpsSimno',sortable:true, width:'20%', align:"left"},
		            ...
		            {name:'caozuo',width:120,fixed:true, sortable:false, resize:false,formatter:
		            	...
		            	div+="<div class='ui-pg-div ui-inline-edit' style='float:left;cursor:pointer;' onclick='editFun(\""+code+"\")'>";
	            			...
	            			div+="</div> <div  class='ui-pg-div ui-inline-del' style='float:left;margin-left:5px;'onclick='addValue(\""+code+"\",\""+name+"\")'>";
