 ...
 * @version 创建时间：2016年5月4日 下午3:29:57 修改人： 修改日期： 类说明:
 */
@Service
@Transactional(noRollbackFor = RuntimeException.class)
public class PartyDifficultServiceImpl implements PartyDifficultService {
	@Autowired
	...
	/* (non-Javadoc)
	 * @see com.dykj.GSM.service.partybuilding.PartyDifficultService#compareSameUser(java.lang.String)
	 */
	@Override
