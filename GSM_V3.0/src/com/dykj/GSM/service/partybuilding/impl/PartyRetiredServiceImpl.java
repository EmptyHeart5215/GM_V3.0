 ...
 * @version 创建时间：2016年5月4日 下午3:24:50 修改人： 修改日期： 类说明:
 */
@Service
@Transactional(noRollbackFor = RuntimeException.class)
public class PartyRetiredServiceImpl implements PartyRetiredService {
	@Autowired
	...
	/* (non-Javadoc)
	 * @see com.dykj.GSM.service.partybuilding.PartyRetiredService#compareSameUser(java.lang.String)
	 */
	@Override
