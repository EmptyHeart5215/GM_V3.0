...
import com.dykj.GSM.mapper.eva.impl.AppraiseDepartmentMapperImpl;
...
@Service
public class AppraiseDepartmentServiceImpl implements AppraiseDepartmentService {
	@Autowired
	private AppraiseDepartmentMapperImpl appraiseDepartmentMapperImpl;
	@Autowired
	...
	public int insertBySelect(String userCode, Integer year, Integer month, String gridCode) throws Exception {
		...
		if (evaSet != null) {
			...
			// 先将之前考核的全部删除
			appraiseDepartmentMapperImpl.deleteByYearAndMonth(map2);
			...
			return appraiseDepartmentMapperImpl.insertBySelect(map2);
		} else {
	...
	public Map<String, Object> getDetailOfAppraise(String primaryKey) {
		...
		AppraiseDepartment appraise = appraiseDepartmentMapperImpl.queryByKey(primaryKey);
	...
	@Override
	public Page<AppraiseDepartment> queryByMapPage(String sidx, int rows, int page, String sord, Integer year,
			Integer month, String gridCode) throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("year", year);
		map.put("month", month);
		map.put("gridCode", gridCode);
		return appraiseDepartmentMapperImpl.queryByMapPage(page, rows, sidx, sord, map);
	}
	 ...
	 */
	@Override
	public Page<AppraiseDepartment> queryStatisticsPage(String sidx, int rows, int page, String sord, Integer year,
		...
		map.put("type", type);
		map.put("jiDu", jiDu);
		return appraiseDepartmentMapperImpl.queryStatisticsPage(page, rows, sidx, sord, map);
	}

	@Override
	public int insert(AppraiseDepartment entity) throws Exception {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int update(AppraiseDepartment entity) throws Exception {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public AppraiseDepartment queryByKey(String primaryKey) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<AppraiseDepartment> queryList() throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<AppraiseDepartment> queryListParam(Map param) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<AppraiseDepartment> queryTListParam(AppraiseDepartment param) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Page<AppraiseDepartment> queryByParamPage(int page, int size, String sidx, String sord,
			AppraiseDepartment param) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
