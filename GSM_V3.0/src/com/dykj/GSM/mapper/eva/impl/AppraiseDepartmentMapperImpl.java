...
import com.dykj.GSM.mapper.eva.mapperinterf.AppraiseDepartmentMapper;
import com.dykj.GSM.mapper.support.Page;
import com.dykj.GSM.mapper.support.PageResult;
import com.dykj.GSM.model.eva.AppraiseDepartment;

public class AppraiseDepartmentMapperImpl extends BaseMapperImpl<AppraiseDepartment, String> implements
		AppraiseDepartmentMapper {
	@Override
	 ...
	 */
	@Override
	public Page<AppraiseDepartment> queryStatisticsPage(int pageNum, int size, String sidx, String sord, Map param) {
