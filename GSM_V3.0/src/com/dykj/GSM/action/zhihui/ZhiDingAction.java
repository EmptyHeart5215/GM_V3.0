...
@RestController
@RequestMapping(value = "/zhihuizhongxin/zhiding")
public class ZhiDingAction extends BaseAction {
	private static Logger logger = Logger.getLogger(ZhiDingAction.class);
	...
	public ModelAndView manageLoad() {
		return new ModelAndView("/zhihuizhongxin/zhiding/manage");
	}
	...
	public ModelAndView addLoad() {
		...
		vdata.put("url", "/zhihuizhongxin/zhiding/add");
		return new ModelAndView("/zhihuizhongxin/zhiding/info", "vdata", vdata);
	}
	...
	public ModelAndView modifyLoad(String code) {
		...
		vdata.put("url", "/zhihuizhongxin/zhiding/modify");
