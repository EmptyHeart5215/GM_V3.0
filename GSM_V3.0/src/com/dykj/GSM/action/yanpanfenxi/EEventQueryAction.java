...
@RestController
@RequestMapping(value = "/yanpanfenxi/eventquery")
public class EEventQueryAction extends BaseAction {
	private static Logger logger = Logger.getLogger(EEventQueryAction.class);
	@Autowired
	...
	public ModelAndView zongheManageLoad() {
		return new ModelAndView("/yanpanfenxi/eventquery/zongheManage");
	}
	...
	public Object zongheManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			return eventService.queryZongHePage(sidx, rows, page, sord, m);
		} catch (Exception e) {
			e.printStackTrace();
