		...
		<div class="col-xs-12" id="body">
			...
			<input type="hidden" name="code" value="${vdata.sysDic.code }" />
				<div class="form-group">
					...
					<div class="col-xs-10">
						<input type="text" max-length="50"id="nameDic" name="nameDic" value="${vdata.sysDic.nameDic }" class="col-xs-10 col-sm-5 tooltip-error required" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-10">
						<div class="clearfix">
								<textarea id="" name="remark" class="col-xs-10 col-sm-5">${vdata.sysDic.remark }</textarea>
						</div>
					</div>
				</div>
