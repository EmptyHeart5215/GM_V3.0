...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/mem/gridmember/queryManage",
		        ...
		        autowidth:true,//自动宽
		        defaultCaozuo:false,
		        colNames:[ '字典主键', '所属辖区或部门','考核对象','民情日记','巡查走访','矛盾联动化解','总分'],
		        colModel:[
					{name:'code',index:'code',sortable:false, hidden:true},
		            {name:'gridName',index:'gridName',sortable:true, width:'15%',align:'left'},
		            {name:'nameUser',index:'nameUser',sortable:true, width:'20%', align:"left"},
		            {name:'logScore',index:'logScore',sortable:true, width:'20%', align:"left"},
		            {name:'trackScore',index:'trackScore', width:'35%', align:"left", sortable:false},
		            {name:'serviceScore',index:'serviceScore',sortable:true, width:'20%', align:"left"},
