...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/mem/departmentstatic/queryManage",
		        ...
		        autowidth:true,//自动宽
		        defaultCaozuo:false,
		        colNames:[ '字典主键', '所属辖区或部门','按时办结率','返工率','群众满意度','总分'],
		        colModel:[
					{name:'code',index:'code',sortable:false, hidden:true},
		            {name:'nameDepartment',index:'nameDepartment',sortable:true, width:'15%',align:'left'},
		            {name:'delayreduceScore',index:'delayreduceScore',sortable:true, width:'20%', align:"left"},
		            {name:'havenotreduceScore',index:'havenotreduceScore',sortable:true, width:'20%', align:"left"},
		            {name:'pleasereduceScore',index:'pleasereduceScore', width:'35%', align:"left", sortable:false},
