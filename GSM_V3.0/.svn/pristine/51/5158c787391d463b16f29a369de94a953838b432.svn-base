 ...
 * @version 创建时间：2016年5月3日 下午4:24:00 修改人： 修改日期： 类说明:
 */
@Service
@Transactional(noRollbackFor = RuntimeException.class)
public class PartyAllServiceImpl implements PartyAllService {
	@Autowired
	...
	/* (non-Javadoc)
	 * @see com.dykj.GSM.service.partybuilding.PartyAllService#compareSameUser(java.lang.String)
	 */
	@Override
