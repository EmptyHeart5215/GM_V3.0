...
<!-- 			<h2 class="text-center">组织生活</h2> -->
			<input type="hidden" name="code" value="${vdata.bfeigong.code }" />
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text"id="gridCode" name="gridCode" value="${vdata.bfeigong.gridCode }" class="col-xs-12 col-sm-12" />
					</div>
				 ...
				 <div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" max-length="50"id="manager" name="manager" value="${vdata.bfeigong.manager }" class="col-xs-12 col-sm-12 tooltip-error required" />
					</div>
					<label id="sss" class="col-xs-2 control-label no-padding-right text-right" for="codeHouseSource">房屋来源</label>
					<div class="col-xs-4">
						<input type="text" max-length="50"id="codeHouseSource" name="codeHouseSource" value="${vdata.bfeigong.codeHouseSource }" class="col-xs-12 col-sm-12 " />
					</div>
				</div>
				<div class="form-group">
					<label id="sss" class="col-xs-2 control-label no-padding-right text-right" for="liveNum"><span class="red">*</span>居住人数</label>
					<div class="col-xs-4">
						<input type="text" max-length="50"id="liveNum" name="liveNum" value="${vdata.bfeigong.liveNum }" class="col-xs-12 col-sm-12 tooltip-error digits required" />
					</div>
					<label class="col-xs-2 control-label no-padding-right text-right" ><span class="red">*</span>注册时间</label>
					<div class="col-xs-4 input-group">
						<input class="form-control date-picker tooltip-error required" name="registerDate" value="${vdata.bfeigong.registerDate }"  type="text">
				...
				<div class="form-group">
					<label class="col-xs-2 control-label no-padding-right text-right" for="position"><span class="red">*</span>地图定位</label>
					   <div class="col-xs-4 input-group">
					    <input class="form-control position-picker tooltip-error required" onclick="getPointXY(this)" id="position" name="position" value="${vdata.bfeigong.position }"type="text">
						<span class="input-group-addon">
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" max-length="50"id="groupManagerPhone" name="groupManagerPhone" value="${vdata.bfeigong.groupManagerPhone }" class="col-xs-12 col-sm-12 tooltip-error allPhone required" />
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" max-length="50"id="gridName" name="gridName" value="${vdata.bfeigong.gridName }" placeholder="选择辖区后自动获取" readonly="readonly" class="col-xs-12 col-sm-12 tooltip-error required" />
					</div>
				</div>				
				<div class="form-group">
...
<!-- 					</div> -->
					...
					<div class="col-xs-4">
						<input type="text" max-length="50"id="gridPhone" name="gridPhone" value="${vdata.bfeigong.gridPhone }" placeholder="选择辖区后自动获取" readonly="readonly" class="col-xs-12 col-sm-12 tooltip-error allPhone required" />
					</div>
					<label id="sss" class="col-xs-2 control-label no-padding-right text-right" for="cardNumber">证照编号</label>
					<div class="col-xs-4">
						<input type="text" max-length="50"id="cardNumber" name="cardNumber" value="${vdata.bfeigong.cardNumber }" class="col-xs-12 col-sm-12 " />
					</div>
				</div>			
				<div class="form-group">
