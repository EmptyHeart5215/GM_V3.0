...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/base/pertsxiejiao/queryManage",
		        defaultCaozuo:false,
		        ...
		        colNames:[ '', '','所属辖区','楼栋','单元','房屋','身份证号','姓名','性别','邪教名称','入教时间'],
		        colModel:[
					...
					{name:'xieJiaoName',sortable:false, width:'15%'},
					{name:'beginDate',sortable:false, width:'15%'}
								...
								<form id="search_form">
									<table style="width:100%;">
										...
										<tr>
											<td >
											<div class="search-group  form-group">
													<label class="col-xs-2 col-myxs-15 control-label text-right" >邪教名称</label>
													<input name="xieJiaoName" type="text" class="text col-xs-2" >
													<label class="col-xs-2 col-myxs-15 control-label text-right">入教时间</label>
													<div class="input-group" style="width:16.6666%;float: left;" >
														<input class="col-xs-12 col-sm-12 form-control date-range-picker"name="beginDate" type="text"/>
