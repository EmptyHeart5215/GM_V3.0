...
<script type="text/javascript">
  $(function(){
	  var partyType = '${vdata.difficultparty.codePartyType }'
       ...
       <div class="tab-content" >
            <div id="detailDiv" class="tab-pane in active">
               <div class="col-xs-12" style='text-align:right;'>
	            ...
	            <div id="print">
					<h2><center>困难党员信息采集表</center></h2>
					<table width="60%" align="center">
					  <tr>
					     <td width="18%">网格编码：</td>
					     <td width="35%">${vdata.difficultparty.gridCode }</td>
					      <td width="18%">创建日期：</td>
					     <td width="35%">${vdata.difficultparty.createDate }</td>
					  </tr>
					</table>
					<table id="tbcontent" align="center" width="100%" border="1">
					   <tr height="28px;">
					     <td width="15%" align="right"><b>所属辖区</b></td>
					     <td width="30%" colspan="3">${vdata.difficultparty.seatGrid.gridTotalName }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>姓名</b></td>
					     <td width="30%">${vdata.difficultparty.name }</td>
					     <td width="15%" align="right"><b>身份证</b></td>
					     <td width="30%">${vdata.difficultparty.cid }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>性别</b></td>
					     <td width="30%">${vdata.difficultparty.sex }</td>
					     <td width="15%" align="right"><b>民族</b></td>
					     <td width="30%">${vdata.difficultparty.dicValueMap.codeNation }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>文化程度</b></td>
					     <td width="30%">${vdata.difficultparty.dicValueMap.codeEducation }</td>
					     <td width="15%" align="right"><b>政治面貌</b></td>
					     <td width="30%">${vdata.difficultparty.dicValueMap.codePolitical }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" align="right"><b>党员类型</b></td>
					     <td width="30%" id="partytype"></td>
					     <td width="15%" align="right"><b>入党时间</b></td>
					     <td width="30%">${vdata.difficultparty.inPartyDate }</td>
					   </tr>
					   <tr height="28px;">
					     <td width="15%" rowspan="2" align="right"><b>备注</b></td>
					     <td width="30%" colspan="3" rowspan="2" style="word-break:break-all; word-wrap:break-word;">${vdata.difficultparty.remark }</td>
					   </tr>
					   <tr height="28px;">
					   </tr>
					</table>
