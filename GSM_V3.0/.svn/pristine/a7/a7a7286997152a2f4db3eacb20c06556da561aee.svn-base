...
<script type="text/javascript">
  $(function(){
	  ...
	  var ytitle="楼栋个数（个）";
	  getTitle(ytitle);
		var url="${base }/charts/bbuildcharts/Charts?t="+ Math.random();
		chartInit(title,$("#search_form").serializeJson(),url);
		//重置
								...
								<table style="width:100%;">
										...
										<tr>
											<td>
														...
														<div class="search-group">
															<label class="col-xs-2 control-label text-right">楼栋长</label>
															<input name="buildManager" type="text" class="text col-xs-2"  >
														</div>
											</td>
										</tr>
