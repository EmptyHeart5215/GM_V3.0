		...
		<div class="col-xs-12" id="body">
			<form class="form-horizontal" role="form" id="form">
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" max-length="50"id="gridCode" name="gridCode" value="${vdata.building.gridCode }" class="col-xs-12 col-sm-12 tooltip-error required" />
					</div>
				...
				<div class="form-group">
					<label class="col-xs-2 control-label no-padding-right text-right" >地图描边</label>
					<div class="col-xs-10">
						<input type="text" max-length="500"id="position" name="position" readonly="readonly" value="${vdata.building.position }" class="col-xs-12 col-sm-12 tooltip-error" />
					</div>
				</div>
				<div class="form-group">
