        ...
        return this.each(function() {
            if (!this.grid) {
                var e = b.extend(!0, {
                    ...
                    colNames: [],
                    showRowList:true,//是否显示选择每条几行的那个框，页数信息，用于人房新增页面
                    sortable:true,
                    sortorder: "asc",
                    sortname: "",
                   /* datatype: "xml",
			        ...
			        loadComplete:function(){
			        	var userData=b(this).getGridParam('userData');
			        	if(JSON.stringify(userData)!="{}"){
			        		bootbox.alert(userData);
			        	}
			        },
                    gridComplete: null,
                    loadError: null,
                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    this.p = e;
                    //-----------------------------------------------自己添加
                    if(this.p.defaultCaozuo){
	                    this.p.colModel=this.p.colModel.concat( {name:'caozuo',width:80,fixed:true, sortable:false, resize:false,formatter:
			            	function(cellvalue, options, rowObject){
			            	var code=rowObject['code'];
			            	var div='<div style="margin-left:8px;">';
			            	div+="<div class='ui-pg-div ui-inline-edit' style='float:left;cursor:pointer;' onclick='editFun(\""+code+"\")'>";
				            	div+='<span class="ui-icon ui-icon-pencil"></span>';
		            			div+="</div> <div  class='ui-pg-div ui-inline-del' style='float:left;margin-left:5px;'onclick='deleteFun(\""+code+"\")'>";
	                    ...
	                    this.p.colNames=this.p.colNames.concat('操作');
		            }
                    //-----------------------------------------------
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                       ...
                       /* b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").insertBefore(i);*/
                        ...
                        ka = function(c, d) {
                            ...
                            l = c + "_center";
                            m = c + "_right";
                            b("#" + b.jgrid.jqID(c)).append("<div id='" + j + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr></td><td id='" + l + "' align='left' style='white-space:pre;'></td><td id='" + m + "' align='left'></td><td id='" + k + "' align='right'></tr></tbody></table></div>").attr("dir", "ltr");
                            if (a.p.rowList.length > 0&&a.p.showRowList) {
                                i = "<td dir='" + f + "'>";
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                f === "rtl" && k.reverse();
                                g = g + ("<td id='" + k[0] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon icon-double-angle-left bigger-140'></span></td>");
                                g = g + ("<td id='" + k[1] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon icon-angle-left bigger-140'></span></td>");
                                g = g + (e !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + e + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>": "") + ("<td id='" + k[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon icon-angle-right bigger-140'></span></td>");
                                g = g + ("<td id='" + k[3] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon icon-double-angle-right bigger-140'></span></td>")
                            } else e !== "" && (g = g + e);
                            f === "ltr" && (g = g + i);
                            g = g + "</tr></tbody></table>";
                            a.p.viewrecords === true && b("td#" + c + "_" + a.p.recordpos, "#" + j).append("<div dir='" + f + "' style='text-align:center' class='ui-paging-info'></div>");
                        ...
                        b("th", i).each(function(d) {
                            ...
                            b(this).css("width", (da-1) + "px").prepend(ea);
                            var e = "";
                            if (a.p.colModel[d].hidden) {
                                b(this).css("display", "none");
                                e = "display:none;"
                            }
                            Z = Z + ("<td role='gridcell' style='height:0px;width:" + (da-1) + "px;" + e + "'></td>");
                            c.headers[d] = {
                                width: da,
                                el: this
                            };
                        ...
                        }).append("<span class='ui-icon icon-chevron-up'></span>").css("rtl" === f ? "left": "right", "0px") : "";
                        b(c.cDiv).append(ia).append("<h5 style='margin-top:8px;'><i class='icon-list'style='margin-left:2px;margin-right:5px;'></i>" + a.p.caption + "</h5>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
                        ...
                        if (a.p.caption) {
                            var ta = a.p.datatype; ! 0 === a.p.hidegrid && (b(".ui-jqgrid-titlebar-close", c.cDiv).click(function(d) {
                                ...
                                function() {
                                    f--;
                                    if (f === 0) {
                                        b("span", h).removeClass("icon-chevron-up").addClass("icon-chevron-down");
                                ...
                                function() {
                                    f--;
                                    if (f === 0) {
                                        b("span", h).removeClass("icon-chevron-down").addClass("icon-chevron-up");
                                        if (H) {
                                            a.p.datatype = ta;
                                            O();
                                            H = false
            ...
            return this.each(function() {
                if (!this.nav) {
                    ...
                    if (h.grid && "string" === typeof b) {
                        ...
                        for (x = 0; x < n; x++) {
                            var f = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:right;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                            o,
                            k;
