...
layer.photos = function(a) {
    ...
    b.event = function() {
        ...
        b.bigimg.find(".xubox_prev").on("click",
        function(a) {
            a.preventDefault(),
            i.imgprev()
        }),
        ...
        b.bigimg.find(".xubox_next").on("click",
        function(a) {
            a.preventDefault(),
            i.imgnext()
        }),
    ...
    b.resize = function(d) {
        ...
        /*b.imgs.outerHeight()>b.imgs.outerWidth()?b.imgs.css({
            height:"100%",
        	width:"auto"
        }) : b.imgs.css({
        	width:"100%",
