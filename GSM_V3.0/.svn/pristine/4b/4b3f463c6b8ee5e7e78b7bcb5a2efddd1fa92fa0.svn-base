	...
	$(function(){
		 $("#grid-table").jqGrid({
		        ...
		        colModel:[
		            ...
		            {name:'dicValueMap.codeSmallType',index:'codeSmallType',sortable:true, width:'20%'},
		            {name:'seatGrid.gridTotalName',index:'gridCode',sortable:false, width:'25%',align:'left'},
		            {name:'enterpriseManage',index:'enterpriseManage',sortable:false, width:'20%'},
		            {name:'codePartsStatus',index:'codePartsStatus',sortable:false, width:'10%'},
