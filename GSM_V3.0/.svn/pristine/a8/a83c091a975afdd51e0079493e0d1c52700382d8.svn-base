...
// 		pIdKey:"parentCode"
// 	});
	if('${vdata.volunteersparty.sex }' == '男'){
		 $("#sex option[value='男']").attr("selected", "selected"); 
	 }else if('${vdata.volunteersparty.sex }' == '女'){
		 $("#sex option[value='女']").attr("selected", "selected"); 
	 }else if('${vdata.volunteersparty.sex }' == 0){
		 $("#sex option[value='0']").attr("selected", "selected"); 
	 }
	
	if('${vdata.volunteersparty.codePartyType}'!=""){
...
<div class="row">
		<div class="col-xs-12" id="body">
			...
			<input type="hidden" name="code" value="${vdata.volunteersparty.code}" />
			<input type="hidden" name="personCode" id="personCode" value="${vdata.volunteersparty.personCode}" />
			<input type="hidden" name="position" class="noshow" id="position" value="${vdata.volunteersparty.position}" />
			<input type="hidden" id="codeNation" name="codeNation" value="${vdata.volunteersparty.codeNation}" />
			<input type="hidden" id="codeEducation" name="codeEducation" value="${vdata.volunteersparty.codeEducation }"/>
			<input type="hidden" id="codePolitical" name="codePolitical" value="${vdata.volunteersparty.codePolitical}"/>
			<input type="hidden" id="codePartyType" name="codePartyType" value="${vdata.volunteersparty.codePartyType}"/>
			...
			<input type="hidden" id="zyzparty1" />
				<div class="form-group">
					...
					<div class="col-xs-10">
						<input type="text"id="gridCode" name="gridCode" value="${vdata.volunteersparty.gridCode }" class="col-xs-12 col-sm-12" />
					
<%-- 						<input type="text" max-length="50"id="gridCode" name="gridCode" value="${vdata.volunteersparty.gridCode}" class="col-xs-12 col-sm-12 tooltip-error required" /> --%>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<div class="clearfix">
						<input type="text" max-length="50" id="name" name="name" value="${vdata.volunteersparty.name}" placeholder="请双击输入框" ondblclick="openPerssonInfo()" class="col-xs-12 col-sm-12 tooltip-error required"/>
						</div>
					</div>
				...
				<div class="form-group">	
					...
					<div class="col-xs-10">
						<div class="clearfix">
						<input type="text" max-length="50"id="cid" name="cid" value="${vdata.volunteersparty.cid}" class="col-xs-12 col-sm-12" />
						</div>
					</div>		
				</div>
				<div class="form-group">
					...
					<div class="col-xs-10 input-group">
						<input class="form-control date-picker tooltip-error required" name="inPartyDate" value="${vdata.volunteersparty.inPartyDate}"  type="text">
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<div class="clearfix">
								<textarea id="remark" name="remark" class="col-xs-12 col-sm-12">${vdata.volunteersparty.remark }</textarea>
						</div>
					</div>
				</div>
