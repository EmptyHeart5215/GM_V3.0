...
@RestController
@RequestMapping(value = "/zhihuizhongxin/hujiao")
public class ZHuJiaoAction extends BaseAction {
	private static Logger logger = Logger.getLogger(ZHuJiaoAction.class);
	...
	public ModelAndView manageLoad() {
		return new ModelAndView("/zhihuizhongxin/hujiao/manage");
	}
