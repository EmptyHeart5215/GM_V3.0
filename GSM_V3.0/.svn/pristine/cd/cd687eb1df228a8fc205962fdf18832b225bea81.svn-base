...
<html lang="en">
	...
	$(function(){
		...
		$("[name=gridCode]").ztreeGrid({
		 ...
		 $("#grid-table").jqGrid({
			 	url : "${base }/base/perqingshaonian/queryManage",
		        defaultCaozuo:false,
		        ...
		        colNames:[ '', '所属辖区','楼栋','单元','房屋','身份证号','姓名','性别','类别','家庭情况'],
		        colModel:[
					{name:'personCode',index:'code',sortable:false, hidden:true},
					...
					{name:'person.cid',index:'cid',sortable:false, width:'10%'},
					{name:'person.name',index:'name',sortable:false, width:'7%'},
					{name:'person.sex',index:'sex',sortable:false, width:'5%'},
		            {name:'dicValueMap.codeQsnType',sortable:false, width:'15%'},
		            {name:'dicValueMap.codeJiaTingSituation',sortable:false, width:'15%'}
								...
								<form id="search_form">
									<table style="width:100%;">
										...
										<tr>
											<td >
												<div class="search-group">
													<label class="col-xs-2 col-myxs-15 control-label text-right" >类别</label>
													<input name="codeQsnType" type="text" class="text col-xs-2" >
													<label class="col-xs-2 col-myxs-15 control-label text-right" >家庭情况</label>
													<input name="codeJiaTingSituation" type="text" class="text col-xs-2" >
												</div>
											</td>
										</tr>
									</table>
