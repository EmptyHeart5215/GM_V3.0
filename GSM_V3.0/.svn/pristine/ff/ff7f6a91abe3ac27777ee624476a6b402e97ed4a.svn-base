 ...
 * @version 创建时间：2016年5月4日 下午2:39:09 修改人： 修改日期： 类说明:
 */
@Service
@Transactional(noRollbackFor = RuntimeException.class)
public class PartyStraightServiceImpl implements PartyStraightService {
	...
	/* (non-Javadoc)
	 * @see com.dykj.GSM.service.partybuilding.PartyStraightService#compareSameUser(java.lang.String)
	 */
	@Override
