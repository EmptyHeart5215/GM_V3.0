...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/base/pertsxidu/queryManage",
		        defaultCaozuo:false,
		        ...
		        colNames:[ '', '','所属辖区','楼栋','单元','房屋','身份证号','姓名','性别','管控情况','初次发现日期'],
		        colModel:[
					...
					{name:'dicValueMap.codeGuanKong',sortable:false, width:'15%'},
		            {name:'firstDate',sortable:false, width:'15%'}
		        ],
								...
								<form id="search_form">
									<table style="width:100%;">
										...
										<tr>
											<td >
											<div class="search-group">
													<label class="col-xs-2 col-myxs-15 control-label text-right" >管控情况</label>
													<input name="codeGuanKong" type="text" class="text col-xs-2" >
													<label class="col-xs-2 col-myxs-15 control-label text-right">初次发现日期</label>
													<div class="input-group" style="width:16.6666%;float: left;" >
														<input class="col-xs-12 col-sm-12 form-control date-range-picker"name="firstDate" type="text"/>
