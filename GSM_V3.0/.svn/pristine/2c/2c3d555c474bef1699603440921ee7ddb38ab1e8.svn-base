...
@RestController
@RequestMapping(value = "/event/econtradict")
public class EContradictAction extends BaseAction {
	private static Logger logger = Logger.getLogger(EContradictAction.class);
	@Autowired
	...
	public ModelAndView draftManageLoad() {
		return new ModelAndView("/event/econtradict/draftManage");
	}

	@RequestMapping(value = "/mapdraftManageLoad")
	public ModelAndView mapdraftManageLoad() {
		return new ModelAndView("/event/econtradict/mapdraftManage");
	}
	...
	public Object draftManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			return contradictService.queryDraftPage(sidx, rows, page, sord, m);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ModelAndView daibanManageLoad() {
		return new ModelAndView("/event/econtradict/daibanManage");
	}
	...
	public Object daibanManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			// m.put("gridCode", model.getGridCode());
			return contradictService.queryDaiBanPage(sidx, rows, page, sord, m, model);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e.getMessage());
		}
	...
	public ModelAndView yibanManageLoad() {
		return new ModelAndView("/event/econtradict/yibanManage");
	}
	...
	public Object yibanManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			return contradictService.queryYiBanPage(sidx, rows, page, sord, m, model.getCode());
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e.getMessage());
		}
	...
	public ModelAndView zhuxiaoManageLoad() {
		return new ModelAndView("/event/econtradict/zhuxiaoManage");
	}
	...
	public Object zhuxiaoManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			return contradictService.queryWanJiePage(sidx, rows, page, sord, m);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e.getMessage());
		}
	...
	public Object mapzhuxiaoManage() {
		try {
			return contradictService.mapqueryWanJiePage();
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e.getMessage());
		}
	...
	public ModelAndView beizhuxiaoManageLoad() {
		return new ModelAndView("/event/econtradict/beizhuxiaoManage");
	}
	...
	public Object beizhuxiaoManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			return contradictService.queryCancelPage(sidx, rows, page, sord, m, model.getCode());
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e.getMessage());
		}
	...
	public ModelAndView dubanManageLoad() {
		return new ModelAndView("/event/econtradict/dubanManage");
	}
	...
	public Object dubanManage(int page, int rows, String sidx, String sord, String args) {
		...
		try {
			...
			return contradictService.queryDuBanPage(sidx, rows, page, sord, m);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e.getMessage());
		}
	...
	public ModelAndView addLoad() {
		...
		try {
			vdata = this.contradictService.queryInitial(session.getCode());
			vdata.put("url", "/event/eevent/add");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new ModelAndView("/event/econtradict/info", "vdata", vdata);
	}
	...
	public ActionMessage eventaccept(@Valid EContradict eevent, @RequestParam String owner, @Valid EOpinion opinion,
		...
		try {
			...
			contradictService.add(eevent, session.getCode(), owner, opinion);
	...
	public ActionMessage eventdraft(EContradict eevent, BindingResult result) {
		try {
			if (result.hasErrors()) {
				List<ObjectError> list = result.getAllErrors();
				ObjectError oe = list.get(0);
			...
			SessionModel session = MySession.getInfo();
			eevent.setCreateBy(session.getCode());
			contradictService.addDraft(eevent);
			return new ActionMessage(true);
		} catch (Exception e) {
			logger.error(e);
	...
	public ModelAndView editDraftLoad(@RequestParam String code) throws Exception {
		SessionModel session = MySession.getInfo();
		Map<String, Object> vdata = this.contradictService.queryInitial(session.getCode());
		// vdata.put("url", "/event/econtradict/info");
		vdata.put("event", contradictService.queryByCode(code));
		return new ModelAndView("/event/econtradict/edit", "vdata", vdata);
	}
	...
	public ModelAndView detailLoad(@RequestParam Long entryId, int stepId, @RequestParam String eventCode) {
		...
		return new ModelAndView("/event/econtradict/approval", "vdata", vdata);
	}
	...
	public Map<String, Object> approvalData(@RequestParam Long entryId, int stepId, @RequestParam String eventCode) {
		SessionModel session = MySession.getInfo();
		try {
			Map<String, Object> vdata = this.contradictService.queryApproval(entryId, session.getCode(),
	...
	public ActionMessage approval(@RequestParam String eventCode, @RequestParam long wfid, @RequestParam int stepId,
		...
		try {
			if (this.contradictService.modifyApproval(eventCode, wfid, stepId, actionId, owner, session.getCode(),
					eopinion, duration, session.getGridCode()) > 0) {
				return new ActionMessage(true);
			} else {
				return new ActionMessage(false);
			}
	...
	public ModelAndView eventGuidLoad() {
		return new ModelAndView("/event/econtradict/eventguide");
	}
	...
	public ActionMessage deleteDraft(String... codes) {
		try {
			contradictService.deleteBatch(Arrays.asList(codes));
			return new ActionMessage(true);
		} catch (Exception e) {
			return new ActionMessage(false);
		}
	...
	public List queryAllSteps() throws FactoryException {
		return (List<String>) contradictService.getAllSteps().get("listValue");
	}

	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/queryAllTreeSteps")
	public List<Map<String, Object>> queryAllTreeSteps() throws FactoryException {
		return (List<Map<String, Object>>) (contradictService.getAllSteps().get("treeMapList"));
	}
	...
	public String queryFlowSteps(@RequestParam String entryId) {
		try {
			...
			Map<String, Object> map = contradictService.queryAllStepsOfOneEvent(entryId);
