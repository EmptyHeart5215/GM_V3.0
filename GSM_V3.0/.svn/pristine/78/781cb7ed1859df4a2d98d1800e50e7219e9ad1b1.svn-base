...
<div class="row">
		<div class="col-xs-12" id="body">
			...
			<input type="hidden" name="code" value="${vdata.inparty.code}" />
			<input type="hidden" name="personCode" id="personCode" value="${vdata.inparty.personCode}" />
			<input type="hidden" name="position" class="noshow" id="position" value="${vdata.inparty.position}" />
			<input type="hidden" id="codeNation" name="codeNation" value="${vdata.inparty.codeNation}" />
			<input type="hidden" id="codeEducation" name="codeEducation" value="${vdata.inparty.codeEducation }"/>
			<input type="hidden" id="codePolitical" name="codePolitical" value="${vdata.inparty.codePolitical}"/>
			<input type="hidden" id="codePartyType" name="codePartyType" value="${vdata.inparty.codePartyType}"/>
			...
			<input type="hidden" id="zyzparty1" />
				<div class="form-group">
					...
					<div class="col-xs-10">
						<input type="text"id="gridCode" name="gridCode" value="${vdata.inparty.gridCode }" class="col-xs-12 col-sm-12" />					
<%-- 						<input type="text" max-length="50"id="gridCode" name="gridCode" value="${vdata.inparty.gridCode}" class="col-xs-12 col-sm-12 tooltip-error required" /> --%>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-4">
						<div class="clearfix">
						<input type="text" max-length="50"id="name" name="name" value="${vdata.inparty.name}" placeholder="请双击输入框" ondblclick="openPerssonInfo()" class="col-xs-12 col-sm-12 tooltip-error required" />
						</div>
					</div>
				...
				<label class="col-xs-2 control-label no-padding-right text-right" for="cid">身份证 </label>
					...
					<div class="col-xs-10">
						<div class="clearfix">
						<input type="text" max-length="50"id="cid" name="cid" value="${vdata.inparty.cid}" class="col-xs-12 col-sm-12 tooltip-error required" />
						</div>
					</div>		
				</div>
				<div class="form-group">
					...
					<div class="col-xs-4">
						<select  id="codePartyType" name = "codePartyType"  class="form-control myselect"  style="width: 100%;" onchange="changeSelect(this.value)">
                           ...
                           <option value="zaizhiparty" selected="true">在职党员</option>
					...
					<div class="col-xs-10 input-group">
						<input class="form-control date-picker tooltip-error required" name="inPartyDate" value="${vdata.inparty.inPartyDate}"  type="text">
...
<!-- 					<div class="col-xs-4"> -->
<!-- 						<div class="clearfix"> -->
<%-- 						<input type="text" max-length="50"id="inPartyDate" name="inPartyDate" value="${vdata.inparty.inPartyDate}" class="col-xs-12 col-sm-12 tooltip-error required" /> --%>
<!-- 						</div> -->
<!-- 					</div> -->
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<div class="clearfix">
								<textarea id="remark" name="remark" class="col-xs-12 col-sm-12">${vdata.inparty.remark }</textarea>
						</div>
					</div>
				</div>
