...
<html lang="en">
	...
	$(function(){
		 $("#grid-table").jqGrid({
			 	url : "${base }/base/pertsaizi/queryManage",
		        defaultCaozuo:false,
		        ...
		        colNames:[ '', '','所属辖区','楼栋','单元','房屋','身份证号','姓名','性别','感染途径','关注类型'],
		        colModel:[
		            ...
		            {name:'dicValueMap.codeGanRanRoute',sortable:false, width:'15%'},
		            {name:'dicValueMap.codeGuanZhuType',sortable:false, width:'15%'}
		        ],
								...
								<form id="search_form">
									<table style="width:100%;">
										...
										<tr>
											<td >
												<div class="search-group">
													<label class="col-xs-2 col-myxs-15 control-label text-right" >感染途径</label>
													<input type="text"  name="codeGanRanRoute" class="col-xs-2 " />
													<label class="col-xs-2 col-myxs-15 control-label text-right">关注类别 </label>
													<input type="text" max-length="50"id="codeGuanZhuType" name="codeGuanZhuType" class="col-xs-2 " />
